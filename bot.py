...
INTRO_TEXT = (
    ...
    "китайской метафизики <tg-emoji emoji-id=\"5321081875467354379\">☯️</tg-emoji>\n\nРазбор — это встреча со своим внутренним я, с сильными и слабыми качествами личности; "
    "это ясный взгляд на здоровье, семью, финансы, профессию, совместимость и другие аспекты вашей жизни."
)

FORMAT_TEXT = (
        "<u>Формат консультации</u>\n\n"
    "🪷 <u>Полный разбор карты ба-цзы</u>\n"
    "По всем сферам вашей жизни, длительностью 2 часа.\n"
    "Формат: онлайн-созвон или личная встреча в Москве/Петербурге.\n"
    "Стоимость: 26.000 ₽\n\n"
    "🪷 <u>Экспресс-консультация</u>\n"
    "На фестивале «Нихао Шифу» 🤫\n"
    "Полный разбор вашего запроса или одной сферы вашей жизни.\n"
    "Длительность: 30 минут.\n"
    "Стоимость: 3.000 ₽\n\n"
    "🪷 Ознакомиться с иными услугами:\n"
    "https://bazi-start.taplink.ws"
)
